...
from ..parsers.ftmscan import ftm_txns, ftm_int, WALLET, WORKSHEET_NAME
...
DataMerge("FtmScan fees & multi-token transactions",
          {TXNS: {'req': DataMerge.MAN, 'obj': ftm_txns},
           TOKENS: {'req': DataMerge.OPT, 'obj': etherscan_tokens},
           NFTS: {'req': DataMerge.OPT, 'obj': etherscan_nfts},
           INTERNAL_TXNS: {'req': DataMerge.OPT, 'obj': ftm_int}},
          merge_ftmscan)
